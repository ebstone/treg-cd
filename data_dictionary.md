...
| `aliyev2019_appendixS1_table2_parameters.csv` | 59 source parameters (trial endpoints, adjustment ratios, costs, utilities) with Beta/Gamma/Uniform distributions | Aliyev et al. 2019, Appendix S1, Supplementary Table 2 | Extracted cleanly (row order intact); high confidence. |
